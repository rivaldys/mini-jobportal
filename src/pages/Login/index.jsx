import { Button, ErrorMessage, Input, InputGroup } from '@/components'
...
const Login = () =>
{
    ...
    const redirectIfAuthenticated = useCallback(() => navigate('/'), [history])
    ...
    {
        e.preventDefault()
        const res = { succeed: redirectIfAuthenticated }
